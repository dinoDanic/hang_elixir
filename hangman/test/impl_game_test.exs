defmodule ImplGameTest do
  ...
  test "new game return corrent word" do
  ...
  test "state dosent change if a game is won or lost" do
  ...
  test "a duplicate ltter is reported" do
    game = Game.new_game()
  ...
  # hello
  test "can handle a saeqoce of move" do
    [
